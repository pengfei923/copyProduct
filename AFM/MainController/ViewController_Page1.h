...
//
@class HomeListModel;
@class HomeListModelCell;


#import "BaseViewController.h"

@interface ViewController_Page1 : BaseViewController
...
@property (nonatomic, strong) NSArray<HomeListModelCell *> *data;


@end


@interface HomeListModelCell : NSObject
