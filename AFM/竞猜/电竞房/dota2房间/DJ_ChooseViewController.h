...
@class DJ_PlayerListModel;
@class DJ_PlayerListModelCell;

@interface DJ_ChooseViewController : BaseViewController

@property (nonatomic , strong) NSString *Id;                  //房间id号
@property (nonatomic , strong) NSString *type;                //lol..dota..nba
...
//------------背景
@property (weak, nonatomic) IBOutlet UIImageView *room_bgImg;//底部背景
@property (weak, nonatomic) IBOutlet UIImageView *type_bgImg;//中间背景
...
@interface DJ_PlayerListModel : NSObject
@property (nonatomic, strong) NSArray<DJ_PlayerListModelCell *> *data;


@end


@interface DJ_PlayerListModelCell : NSObject
@property (nonatomic , strong) NSString *Id;               //房间id号
