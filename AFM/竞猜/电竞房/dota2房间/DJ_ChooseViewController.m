...
@interface DJ_ChooseViewController (){
...
@implementation DJ_ChooseViewController
...
- (void)initView {
    ...
    self.icon_Btn1.layer.cornerRadius = 15;
    self.icon_Btn2.layer.cornerRadius = 15;
    self.icon_Btn3.layer.cornerRadius = 15;
    self.icon_Btn4.layer.cornerRadius = 15;
    self.icon_Btn5.layer.cornerRadius = 15;
    self.icon_Btn6.layer.cornerRadius = 15;
    self.icon_Btn7.layer.cornerRadius = 15;
    self.icon_Btn8.layer.cornerRadius = 15;
...
//    获取房间的所有参赛的球员信息
    ...
    [manager POST: urlStr parameters:paramters progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        if ([[dic objectForKey:@"error"]isEqualToNumber:@0]) {
            DJ_PlayerListModel *listModel = [DJ_PlayerListModel yy_modelWithDictionary:dic];
...
- (void)initAllModel: (DJModel1Cell *)model1 :(DJModel2Cell *)model2 :(DJModel3Cell *)model3 :(DJModel4Cell *)model4 :(DJModel5Cell *)model5 :(DJModel6Cell *)model6 :(DJModel7Cell *)model7 :(DJModel8Cell *)model8{
    ...
    if (model1) {
        if (model1.Id.length >= 1) {
            self.Model1 = model1;
            [self.icon_Btn1 yy_setImageWithURL:[NSURL URLWithString:model1.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn1 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
    ...
    if (model2) {
        if (model2.Id.length >= 1) {
            self.Model2 = model2;
            [self.icon_Btn2 yy_setImageWithURL:[NSURL URLWithString:model2.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn2 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
    ...
    if (model3) {
        if (model3.Id.length >= 1) {
            self.Model3 = model3;
            [self.icon_Btn3 yy_setImageWithURL:[NSURL URLWithString:model3.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn3 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
        }
        [self initAAAAAA];
    ...
    if (model4) {
        if (model4.Id.length >= 1) {
            self.Model4 = model4;
            [self.icon_Btn4 yy_setImageWithURL:[NSURL URLWithString:model4.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn4 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
    ...
    if (model5) {
        if (model5.Id.length >= 1) {
            self.Model5 = model5;
            [self.icon_Btn5 yy_setImageWithURL:[NSURL URLWithString:model5.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn5 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
        }
        [self initAAAAAA];
    ...
    if (model6) {
        if (model6.Id.length >= 1) {
            self.Model6 = model6;
            [self.icon_Btn6 yy_setImageWithURL:[NSURL URLWithString:model6.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn6 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
        }
        [self initAAAAAA];
    ...
    if (model7) {
        if (model7.Id.length >= 1) {
            self.Model7 = model7;
            [self.icon_Btn7 yy_setImageWithURL:[NSURL URLWithString:model7.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn7 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
    ...
    if (model8) {
        if (model8.Id.length >= 1) {
            self.Model8 = model8;
            [self.icon_Btn8 yy_setImageWithURL:[NSURL URLWithString:model8.img] forState:UIControlStateNormal placeholder:[UIImage imageNamed:@"player-defult"]];
            ...
            [self.icon_Btn8 setImage:[UIImage imageNamed:@"player-defult"] forState:UIControlStateNormal];
...
@implementation DJ_PlayerListModel
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"data" : [DJ_PlayerListModelCell class]};
}
@end

@implementation DJ_PlayerListModelCell
