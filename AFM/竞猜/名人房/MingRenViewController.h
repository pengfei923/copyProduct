...
@class MRListModel;
@class MRListModelCell;

@interface MingRenViewController : BaseViewController
...
@interface MRListModel : NSObject
@property (nonatomic, strong) NSArray<MRListModelCell *> *data;
@end


@interface MRListModelCell : NSObject
