...
@class NBAListModel;
@class NBAListModelCell;

@interface NBA_RoomViewController : BaseViewController
...
@interface NBAListModel : NSObject
@property (nonatomic, strong) NSArray<NBAListModelCell *> *data;
@end


@interface NBAListModelCell : NSObject
